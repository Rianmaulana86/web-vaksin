        ...
        <div class="page-passbook">
            <div class="table">
                <table class="table table-sm ">
                    <tr>
                        <td class="name-position">ANDI MALARANGENG</td> <!-- Tambahkan kelas untuk posisi -->
                    </tr>
                    <tr>
                        <td class="birthdate-position">01-AGT-1998</td> <!-- Tambahkan kelas untuk posisi -->
                    </tr>
                    <tr>
                        <td class="sex-position">MALE</td> <!-- Tambahkan kelas untuk posisi -->
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="datevaksin-position">14/08/2022</td> <!-- Tambahkan kelas untuk posisi -->
                    </tr>
                    <tr>
                        <td class="dokter-position">Dr. NANANG SUNANANG</td> <!-- Tambahkan kelas untuk posisi -->
                    </tr>
                    <tr>
                        <td class="valid-start-vaksin-position">Valid 22/02/2000</td> <!-- Tambahkan kelas untuk posisi -->
                    </tr>
                    <tr>
                        <td class="jabatan-dokter-position">CLINIK MEDICAL DOCTOR</td> <!-- Tambahkan kelas untuk posisi -->
                    </tr>
                    <tr>
                        <td class="valid-until-vaksin-position">Until 22/02/2003</td> <!-- Tambahkan kelas untuk posisi -->
                    </tr>
                </table>
            </div>
        </div>
