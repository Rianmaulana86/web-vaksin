          ...
          <div class="card z-index-0">
            ...
            <div class="card-body">
              <form method="POST" action="{{ route('register') }}">
                @csrf
                <div class="mb-3">
                  <input type="text" class="form-control" placeholder="Email" name="name" aria-label="Email">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                  <input type="password" class="form-control" placeholder="Password Confirm" name="password_confirmator" aria-label="Password Confirm">
                </div>
